const timelineData = [
    {
        ...
        summary: "Developing digital solutions to simplify tax filing and connect users with certified accountants.", link: "https://taxfix.com/en-gb/",
        achievements: [],
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                title: "Software Developer @ Palmerston North City Council",
                ...
                achievements: [
                    ...
                    "Device configuration UI for operators",
                    "Offline-safe data storage and syncing"
                ],
                skills: "React, TypeScript, Electron, Node.js, Amazon Web Services (AWS)"
            },
            {
            ...
            },
            {
                ...
                skills: "Flutter, Dart, Firebase, Application Deployment, Amazon Web Services (AWS)"
            },
            {
                title: "Application Support Analyst @ Massey University",
                date: "Sep 2021 - Feb 2022",
                location: "New Zealand",
                summary: "Provided technical solutions for legacy systems, ensuring minimal downtime and effective resolution of user-reported issues.",
                achievements: [
                    "Diagnosed and resolved issues across legacy applications and internal systems",
                    "Followed established communication and escalation channels to ensure timely problem resolution",
                    "Collaborated with stakeholders to identify recurring issues and implement preventive measures",
                    "Maintained documentation of system issues and fixes to support team knowledge sharing"
                ],
                skills: "Application Support, CRM Integration, SITS"
            }
        ]
    }
];